    ...
    LoginPage.prototype.doLogin = function () {
        ...
        this.oneService.login(this.loginForm.value).subscribe(function (data) {
            ...
            if (!data.error) {
                ...
                var allowedResturants = _this.driver.kitchensallow;
                console.log("navCtrl");
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, events, locationTracker, alertCtrl, toastCtrl, loadingCtrl, statusBar, splashScreen, threeService, app, badge, afd, 
        ...
        this.pages = [
            ...
            { title: 'Caters', component: __WEBPACK_IMPORTED_MODULE_7__pages_restaurants_restaurants__["a" /* RestaurantsPage */] },
            ...
            if (typeof FCMPlugin != 'undefined') {
                FCMPlugin.onNotification(function (data) {
                    ...
                    if (data.wasTapped) {
                        ...
                        var prompt = _that.alertCtrl.create({
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"D:\Caterdaay\CaterdaayDriverApp\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header >\n\n    <ion-toolbar color="secondary">\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      \n\n      </button>\n\n      <!-- <button menuClose ion-item (click)="doLogout()">\n\n        Logout\n\n      </button> -->\n\n      \n\n    </ion-list> \n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n\n\n\n<ion-row *ngIf = "noConnection" class="noconnection" (tap)="retry($event)">\n\n  <ion-col no-padding col-12 text-center>\n\n    <ion-icon name ="refresh" ios="ios-refresh" md="md-refresh"></ion-icon>\n\n  </ion-col>\n\n  <ion-col no-padding col-12 text-center>Tap to Reload</ion-col>\n\n</ion-row>'/*ion-inline-end:"D:\Caterdaay\CaterdaayDriverApp\src\app\app.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_8__services_location_service__["a" /* LocationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__services_location_service__["a" /* LocationService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_9__services_three_service__["a" /* ThreeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__services_three_service__["a" /* ThreeService */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */]) === "function" && _l || Object, typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_10__ionic_native_badge__["a" /* Badge */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_10__ionic_native_badge__["a" /* Badge */]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_12_angularfire2_database__["a" /* AngularFireDatabase */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12_angularfire2_database__["a" /* AngularFireDatabase */]) === "function" && _o || Object, typeof (_p = typeof __WEBPACK_IMPORTED_MODULE_11__ionic_native_network__["a" /* Network */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_11__ionic_native_network__["a" /* Network */]) === "function" && _p || Object])
    ], MyApp);
    return MyApp;
...
var OrderPage = /** @class */ (function () {
    ...
    function OrderPage(navCtrl, navParams, modalCtrl, threeService, oneService, loadingCtrl, toastCtrl, alertCtrl, afd) {
        ...
        var allowedResturants = this.driver.kitchensallow;
        ...
        this.threeService.getOrders(allowids).subscribe(function (data) {
            if (!data.error) {
                if (data.message.length > 0) {
                    ...
                    var pendingorders = data.message.filter(function (index) {
                    ...
                    var completeOrders = data.message.filter(function (index) {
                        if (typeof index.driverDetail != 'undefined') {
                            return (index.status == 'delivered' && index.driverDetail['_id'] == _this.driver['_id']);
                        }
                    });
                    _this.pendorders = new Array();
                    _this.compOrders = new Array();
                    console.log("in");
                    for (var i = pendingorders.length - 1; i >= 0; i--) {
                        console.log(pendingorders[i], "find me");
                        _this.pendorders.push(pendingorders[i]);
                    }
                    for (var i = completeOrders.length - 1; i >= 0; i--) {
                        _this.compOrders.push(completeOrders[i]);
                    }
                }
            }
            _this.loading.dismiss();
...
var OrderDetailPage = /** @class */ (function () {
    ...
    OrderDetailPage.prototype.CheckMinimumDelivery = function (deliverytime) {
        var today = __WEBPACK_IMPORTED_MODULE_5_moment___default()();
        var newdeliver = __WEBPACK_IMPORTED_MODULE_5_moment___default()(deliverytime);
        var current = __WEBPACK_IMPORTED_MODULE_5_moment___default()();
        newdeliver.subtract({ hours: 1, minutes: 0 });
        console.log(__WEBPACK_IMPORTED_MODULE_5_moment___default()(newdeliver).format("LLLL"));
        var response = today.isAfter(newdeliver);
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        if (status == 'driveraccepted') {
                            _this.driver.orderIds.push(_this.orderDetail._id);
                            _this.oneService.editDriver(_this.driver).subscribe(function (data) {
                                if (!data.error) {
                                    console.log("udpate");
                                }
                            });
                            _this.oneService.getDriver(_this.driver._id).subscribe(function (data) {
                                console.log(data, "updated driver");
                            });
